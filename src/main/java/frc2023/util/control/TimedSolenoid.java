...
public class TimedSolenoid extends Solenoid {
	...
	public TimedSolenoid(int moduleID, PneumaticsModuleType moduleType, int channel, double extensionDurationSeconds, boolean isExtendedByDefault) {
		super(moduleID, moduleType, channel);
		mExtensionDurationSeconds = extensionDurationSeconds;
		mIsExtendedByDefault = isExtendedByDefault;
	}
