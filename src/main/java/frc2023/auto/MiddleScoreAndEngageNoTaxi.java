...
public class MiddleScoreAndEngageNoTaxi extends AutoBase {

	RobotState state;

	public MiddleScoreAndEngageNoTaxi(RobotState state) {
		this.state = state;
	}

	@Override
	public RoutineBase getRoutine() {
		var firstPath = new DrivePathPlannerRoutine("FiveToEngageNoTaxi", 1.2, 3, Robot.alliance, false, this.state);
